...
```
cdk deploy --all --parameters AmplifyStack:githubRepoName=Digital-Learning-Strategy --context VpcStackName=DigitalLearningStrategyVpcStack --context DatabaseStackName=DigitalLearningStrategyDatabaseStack --context ApiStackName=DigitalLearningStrategyApiStack --context DbFlowStackName=DigitalLearningStrategyDBFlowStack --context AmplifyStackName=DigitalLearningStrategyAmplifyStack --context prefix="Digital-Learning-Strategy-production" --profile <your-profile-name>
```

...
export const createCognitoResources = (scope: Construct) => {
    const userPoolName = "DSAUserPool";
      const userPool = new cognito.UserPool(scope, "DSA-pool", {
      ...
      // Create app client
      const appClient = userPool.addClient("DSA-pool", {
      ...
      const identityPool = new cognito.CfnIdentityPool(scope, "dls-identity-pool", {

...
def get_response(
    ...
    system_prompt = (
        ...
        "Respond as you would to a clinician working with patients with Bipolar Disorder. "
        "At the beginning of your response, repeat word for word the first 3 paragraphs of the documents below. "
        "Do that in the form of -----Documents used to respond: <First 3 paragraph of the documents.>-----"
        "Follow this by your exact, informative and detailed response to the user's question."

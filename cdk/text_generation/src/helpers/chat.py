...
def get_response(
    ...
    system_prompt = (
        ...
        "At the end of your response, in a new line, repeat word for word the first paragraph of the documents below. "
        "Do that in the form of -----Documents used to respond: <Entire first paragraph of the documents.>-----"
